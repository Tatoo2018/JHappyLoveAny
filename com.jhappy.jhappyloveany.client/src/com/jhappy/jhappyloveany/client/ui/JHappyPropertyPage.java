...
public class JHappyPropertyPage extends PropertyPage {
    ...
    private void createDefaultConfigFile() {
        ...
        String content = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                ...
                "    <query filepath=\".*\\.xml$\" trim=\"yes\" type=\"xml\" description=\"General XML ID\"><![CDATA[//@id]]></query>\n" +
                "    <query filepath=\"src/.*\\.properties$\" trim=\"yes\" type=\"properties\" description=\"All properties files\" />\n" +
                "</queries>";

        try {
            configFile.create(new ByteArrayInputStream(content.getBytes("UTF-8")), true, null);
